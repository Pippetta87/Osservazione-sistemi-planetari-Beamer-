...
\begin{figure}[!ht]\includegraphics[trim={0cm 0cm 0 0},clip, keepaspectratio,height=0.42\textheight]{Tflux}\label{fig:Tflux}\end{figure}
\begin{figure}[!ht]\includegraphics[trim={0cm 0cm 0 0},clip, keepaspectratio,height=0.42\textheight]{Tflux-b-lambda}\label{fig:Tflux-b-lambda}\end{figure}
\end{column}
...
\end{column} \begin{column}{\textwidth}\end{column}  \end{columns}
